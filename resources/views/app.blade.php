	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Sistema Gestión de Usuario</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{route('cargar-data')}}">Cargar Excel</a></li>
                </ul>
                <ul class="nav navbar-nav">
                 
                </ul>
                <ul class="nav navbar-nav">
                    <li><a href="{{route('configuracion-area')}}">Configuración</a></li>

                </ul>
               <!--  <ul class="nav navbar-nav">
                    <li><a href="{{route('getInfo')}}">phpInfo</a></li>
